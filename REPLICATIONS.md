...
| 07 · Replication workshop | The five articles of sessions 02–06, one replication each | The four packages above, plus `qmib.load("fdi")` | Three hours in autonomy: rebuild one published result from each with only the code seen in class — step-by-step guides in [`07-…/02-practice/replications/`](07-replication-workshop/02-practice/replications/). |
