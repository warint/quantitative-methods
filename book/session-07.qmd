---
title: "Session 7 — Principal Component and Factor Analyses"
---

::: {.chapter-meta}
Wednesday 14 October 2026 · 15:30–18:30 · Décelles — Victoriaville

[Lecture slides](https://warint.github.io/quantitative-methods/session-07-lecture.html) · [Pre-session slides](https://warint.github.io/quantitative-methods/session-07-pre-session.html) · [Practice slides](https://warint.github.io/quantitative-methods/session-07-practice.html)
:::
...
| **Reading** | Koopman & Mesters (2017), *Empirical Bayes Methods for Dynamic Factor Models* · [article](https://doi.org/10.1162/REST_a_00614) |
| **Replication package** | [10.7910/DVN/NKWMQM](https://doi.org/10.7910/DVN/NKWMQM) |
| **Data** | `qmib.load("movies")` — 45,000 films — budget, popularity, revenue, runtime and votes |


::: {.warn}
**This is the last session examined by the midterm**, written Wednesday 28 October 2026. Everything from
...
> source: [`MATH60033A-S07-Pre-Session.qmd`](https://github.com/warint/quantitative-methods/blob/main/MATH60033A-S07-Pre-Session.qmd)
...
[Session 07 overview](session-07.qmd) · [The lecture](#the-lecture) ·
[The practice](#in-the-practice)

## The lecture

::: {.muted}
Delivered from [the slides](https://warint.github.io/quantitative-methods/session-07-lecture.html). What follows is the same material as prose.
:::
...
::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/cross-validation.png){style="display: block; margin: auto;" width="100%"}
:::
...
::: pull-left
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-6-1.png)
:::

::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/bayes-classifier.png){style="display: block; margin: auto;" width="100%"}
:::
:::::

## Introduction

![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/learning-taxonomy.png){style="display: block; margin: auto;" width="100%"}
...
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/dimension-reduction-map.png){style="display: block; margin: auto;" width="88%"}
...
::: pull-left
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/pca-axes.png){style="display: block; margin: auto;" width="88%"}
:::

::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/pca-biplot.png){style="display: block; margin: auto;" width="88%"}
:::
:::::
...
::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/pca-axes.png){style="display: block; margin: auto;" width="100%"}
:::
...
## The Netflix\'s Recommender System through a PCA
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-18-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-23-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-24-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-27-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-28-1.png)
:::
...
## Two examples : the wine data and the cars questionnaire
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-32-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-33-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-34-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-35-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-36-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-38-1.png)
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-41-1.png)
:::

## Factor Analysis for Questionnaires

::: pull-left
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-42-1.png)
:::
...
## When to use PCA and when to use Factor Analysis?
...
> source: [`MATH60033A-S07-Practice.qmd`](https://github.com/warint/quantitative-methods/blob/main/MATH60033A-S07-Practice.qmd)
...
[<- The lecture](#the-lecture) · [Session 07 overview](session-07.qmd)
