---
title: "Session 12 — Final Group Presentations"
---

::: {.chapter-meta}
Wednesday 2 December 2026 · 15:30–18:30 · Décelles — Victoriaville

[Lecture slides](https://warint.github.io/quantitative-methods/session-12-lecture.html) · [Pre-session slides](https://warint.github.io/quantitative-methods/session-12-pre-session.html)
:::

> **Can you make a decision-maker act on this — and say what would change your mind?**
...
[Session 11 practice](session-11.qmd); here you finish them.

#### 1. Model governance file  *(7 of the team work's 20)*

- [ ] All seven sections of [`governance-file-template.md`](session-11.qmd) completed
...
- [ ] An answer to each question in the [session README](session-12.qmd)
...
[Back to session 12](session-12.qmd)
