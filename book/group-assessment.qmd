---
title: "How group work is assessed"
---
...
The form is [`assessment/peer-ratings/FORM.md`](https://github.com/warint/quantitative-methods/blob/main/assessment/peer-ratings/FORM.md). It takes five
...
- the **final exam (40%)**, which is individual in both components — the
  [paper is written alone](https://github.com/warint/quantitative-methods/blob/main/assessments/final-paper/README.md) and the oral examines each student
...
*Related: [course overview](https://github.com/warint/quantitative-methods/blob/main/README.md) · [research
mandates](mandates.qmd) · [Session 12](session-12.qmd)*
