...
Full brief: **[`RESEARCH-MANDATES.md`](mandates.qmd)**.
...
Example paper with full solutions: [`assessments/midterm/`](https://github.com/warint/quantitative-methods/blob/main/assessments/midterm/).
...
Details and rubric: [Session 12](session-12.qmd).
...
[`assessments/final-paper/`](https://github.com/warint/quantitative-methods/blob/main/assessments/final-paper/README.md).
...
[Session 01 setup guide](session-01.qmd).
...
[`assessments/final-paper/`](https://github.com/warint/quantitative-methods/blob/main/assessments/final-paper/README.md#llm-use-statement).
...
|---|---|
| [`README.md`](https://github.com/warint/quantitative-methods/blob/main/README.md) | Course overview and repository layout |
| **`SYLLABUS.md`** | This document |
| [`RESEARCH-MANDATES.md`](mandates.qmd) | The ten projects, ten groups, session themes, data sources |
| [`GROUP-ASSESSMENT.md`](group-assessment.qmd) | Participation, presenter draw, contribution report, peer ratings |
| [`assessments/midterm/`](https://github.com/warint/quantitative-methods/blob/main/assessments/midterm/) | Example paper and full solutions |
| [`assessments/final-paper/`](https://github.com/warint/quantitative-methods/blob/main/assessments/final-paper/README.md) | The SDAfrique brief and rubric |
