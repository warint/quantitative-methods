---
title: "Session 2 — Exploratory Data Analysis, and the First Model"
---
...
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/mean-median.png){.r-stretch}
...
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/shape.png){.r-stretch}
:::
...
([`RESEARCH-MANDATES.md`](mandates.qmd)). Today you profile the three variables that
