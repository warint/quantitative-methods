...
![](images/decks/session-08-economist-assets-knn-boundary.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](images/decks/session-08-economist-assets-nearest-neighbours.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](images/decks/session-08-economist-assets-bias-variance.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](images/decks/session-08-economist-assets-underfit.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](images/decks/session-08-economist-assets-overfit.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](images/decks/session-08-economist-assets-error-complexity.png){style="display: block; margin: auto;" width="78%"}
...
::: pull-right
![](images/decks/session-08-economist-assets-knn-boundary.png){style="display: block; margin: auto;" width="100%"}
:::
:::::
...
::: pull-right
![](images/decks/session-08-economist-assets-nearest-neighbours.png){style="display: block; margin: auto;" width="100%"}
:::
...
::: pull-right
![](images/decks/session-08-economist-assets-complexity-compare.png){style="display: block; margin: auto;" width="100%"}
:::
:::::::
...
::: pull-right
![](images/decks/session-08-economist-assets-error-complexity.png){style="display: block; margin: auto;" width="100%"}
:::
...
![](images/decks/session-08-economist-assets-confusion-matrix.png){style="display: block; margin: auto;" width="72%"}
...
![](images/decks/session-08-imported-assets-index_files-figure-html-unnamed-chunk-26-1.png)
