---
title: "Session 8 — K-Nearest Neighbours and the Bias–Variance Trade-off"
---

::: {.chapter-meta}
Wednesday 4 November 2026 · 15:30–18:30 · Décelles — Victoriaville

[Lecture slides](https://warint.github.io/quantitative-methods/session-08-lecture.html) · [Pre-session slides](https://warint.github.io/quantitative-methods/session-08-pre-session.html) · [Practice slides](https://warint.github.io/quantitative-methods/session-08-practice.html)
:::
...
| **Reading** | Amsili, van Es & Schindelbeck (2025), *Pedotransfer Functions for Soil Protein Based on Random Forest Modeling* · [article](https://doi.org/10.1080/00103624.2025.2454015) |
| **Replication package** | [10.7910/DVN/HGBPCW](https://doi.org/10.7910/DVN/HGBPCW) |
...
> source: [`MATH60033A-S08-Pre-Session.qmd`](https://github.com/warint/quantitative-methods/blob/main/MATH60033A-S08-Pre-Session.qmd)
...
[Session 08 overview](session-08.qmd) · [The lecture](#the-lecture) ·
[The practice](#in-the-practice)

## The lecture

::: {.muted}
Delivered from [the slides](https://warint.github.io/quantitative-methods/session-08-lecture.html). What follows is the same material as prose.
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/knn-boundary.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/nearest-neighbours.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/bias-variance.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/underfit.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/overfit.png){style="display: block; margin: auto;" width="78%"}

## Bias--Variance Trade-off

![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/error-complexity.png){style="display: block; margin: auto;" width="78%"}
...
::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/knn-boundary.png){style="display: block; margin: auto;" width="100%"}
:::
:::::
...
::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/nearest-neighbours.png){style="display: block; margin: auto;" width="100%"}
:::
...
::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/complexity-compare.png){style="display: block; margin: auto;" width="100%"}
:::
:::::::
...
::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/error-complexity.png){style="display: block; margin: auto;" width="100%"}
:::
...
## KNN by hand (you are the algorithm)
...
## KNN in R code (you are not longer the algorithm)

## Machine Learning: using KNN as an example
...
![](https://github.com/warint/quantitative-methods/blob/main/economist-assets/confusion-matrix.png){style="display: block; margin: auto;" width="72%"}
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-26-1.png)
...
> source: [`MATH60033A-S08-Practice.qmd`](https://github.com/warint/quantitative-methods/blob/main/MATH60033A-S08-Practice.qmd)
...
[<- The lecture](#the-lecture) · [Session 08 overview](session-08.qmd)
