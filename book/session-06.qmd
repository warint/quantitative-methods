---
title: "Session 6 — Regression: Advanced Considerations"
---

::: {.chapter-meta}
Wednesday 7 October 2026 · 15:30–18:30 · Décelles — Victoriaville · **asynchronous**

[Lecture slides](https://warint.github.io/quantitative-methods/session-06-lecture.html) · [Pre-session slides](https://warint.github.io/quantitative-methods/session-06-pre-session.html) · [Practice slides](https://warint.github.io/quantitative-methods/session-06-practice.html)
:::
...
| | |
|---|---|
| **Theme of the practice** | Does your finding survive the structure of your data? |
| **Reading** | Topalova & Khandelwal (2011), *Trade Liberalization and Firm Productivity* · [article](https://doi.org/10.1162/REST_a_00095) |
| **Replication package** | [10.7910/DVN/8WEXYD](https://doi.org/10.7910/DVN/8WEXYD) |
| **Data** | `qmib.load("panel")` — a country panel of government debt and economic-freedom indices |
...
> source: [`MATH60033A-S06-Pre-Session.qmd`](https://github.com/warint/quantitative-methods/blob/main/MATH60033A-S06-Pre-Session.qmd)
...
[Session 06 overview](session-06.qmd) · [The lecture](#the-lecture) ·
[The practice](#in-the-practice)

## The lecture

::: {.muted}
Delivered from [the slides](https://warint.github.io/quantitative-methods/session-06-lecture.html). What follows is the same material as prose.
:::
...
#### Advanced validity solutions (beyond the scope of this course)
...
::: pull-left
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/figures/regression2a.png){style="display: block; margin: auto;" width="100%"}
:::

::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/figures/regression2b.png){style="display: block; margin: auto;" width="100%"}
:::
:::::

## Step 2. Fixed effects versus random effects
...
::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-9-1.png)
:::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/figures/binary1.png){style="display: block; margin: auto;" width="60%"}
...
##### How can we incorporate this variable into a linear regression model?
...
#### How can we allow for the relationship of bonus pay with age to be different for men and women?
...
::: pull-left
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/index_files/figure-html/unnamed-chunk-22-1.png)
:::
...
#### 3.1 Comparing models done with lm()
...
::: pull-left
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/figures/stepwise1.png){style="display: block; margin: auto;" width="80%"}
:::

::: pull-right
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/figures/stepwise2.png){style="display: block; margin: auto;" width="80%"}
:::
:::::::
...
![](https://github.com/warint/quantitative-methods/blob/main/imported-assets/figures/regression1.png){style="display: block; margin: auto;" width="100%"}
...
> source: [`MATH60033A-S06-Practice.qmd`](https://github.com/warint/quantitative-methods/blob/main/MATH60033A-S06-Practice.qmd)
...
[<- The lecture](#the-lecture) · [Session 06 overview](session-06.qmd)
