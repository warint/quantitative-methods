...
::: {.warn}
This deposit is **about 220 MB** — much the largest in the course. Start the download before you sit down to read, not while the room is waiting for you.
:::
...
::: {.muted}
The regression fitted at the top of the lecture — GDP per capita on productivity · everything available: `qmib.catalog()`
:::
