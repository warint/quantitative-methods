...
mkdir -p groups/A2026/group-XX/session-03      # macOS and Linux
```

```powershell
git checkout -b group-XX
mkdir groups/A2026/group-XX/session-03         # Windows — no -p
```
...
**[warin.ca/qmib-labs](https://warin.ca/qmib-labs/qmib-lab-03.html)**
:::
