# Session 03 — Group practice (second half, ~90 min)
...
mkdir -p groups/A2026/group-XX/session-03
```
...
```bash
git add groups/A2026/group-XX/session-03
...
[<- The lecture](../01-lecture/README.md) · [Session 03 overview](../README.md)
