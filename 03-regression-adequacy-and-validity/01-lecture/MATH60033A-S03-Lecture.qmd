...
2. Why Evaluate Models?
3. Introduction: Key Aspects of Model Evaluation
4. Models: Assessing the adequacy
5. Models: assessing the validity
6. Model Robustness/Parsimony and Selection
...
The 9 names below came out of session 2. Today's slides assume them, and add to them.
