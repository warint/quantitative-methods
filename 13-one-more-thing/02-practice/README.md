# Session 13 — Group practice (second half, ~90 min)

# One More Thing: Principal Component and Factor Analyses

> **[Open the practice slides](https://warint.github.io/quantitative-methods/session-13-practice.html)** ·
> source: [`MATH60033A-S13-Practice.qmd`](MATH60033A-S13-Practice.qmd)
...
mkdir -p groups/A2026/group-XX/session-13
```
...
```bash
git add groups/A2026/group-XX/session-13
git commit -m "Session 13 practice — group XX"
...
[<- The lecture](../01-lecture/README.md) · [Session 13 overview](../README.md)
