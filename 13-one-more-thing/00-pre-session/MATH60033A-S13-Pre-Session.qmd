---
title: "Session 13: Before the session"
...
format:
  revealjs:
    ...
    margin: 0.06
    smaller: true
    footer: "MATH60033A · Session 13 pre-session · Thierry Warin, PhD · HEC Montréal"
---
...
::: {.muted}
The KOF Globalisation Index — 180 countries, 1970–2023, six sub-dimensions each split into de facto and de jure · everything available: `qmib.catalog()`
:::
...
::: {.muted}
Session 13: [`README.md`](../README.md) ·
