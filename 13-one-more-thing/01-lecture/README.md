# Session 13 — Lecture (first half, ~90 min)
...
> **Python cheatsheet — [session 13](https://warint.github.io/quantitative-methods/python-cheatsheet-13.pdf)** (PDF) ·
...
> the DataFrame basics, and every name taught in sessions 1 to 13 with a
...
> **[Open the deck](https://warint.github.io/quantitative-methods/session-13-lecture.html)** ·
> source: [`MATH60033A-S13-Lecture.qmd`](MATH60033A-S13-Lecture.qmd)
...
[Back to session 13](../README.md) · [On to the practice ->](../02-practice/README.md) · [The lab for this session ↗](https://warin.ca/qmib-labs/qmib-lab-07.html)
