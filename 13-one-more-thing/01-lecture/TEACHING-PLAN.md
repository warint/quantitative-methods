...
| **10–35** | Multivariate statistics — build it from intuition before notation. |
| **35–60** | Principal Component Analysis — derive it, then run it in Python on the session dataset. |
| **60–80** | Mathematical Model --- Maximize variance of the new components — read the output in units, out loud. |
...
Running PCA on unstandardised columns. Say it explicitly, early, and once more at the end. Misconceptions that go
