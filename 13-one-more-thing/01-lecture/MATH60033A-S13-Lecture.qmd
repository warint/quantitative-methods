---
title: "Session 13 · One More Thing: Principal Component and Factor Analyses"
subtitle: "After the course · for self-study · not examined"
...
format:
  revealjs:
    ...
    margin: 0.06
    smaller: true
    footer: "MATH60033A · Session 13 · Thierry Warin, PhD · HEC Montréal"
---
...
## What session 13 is for {.scrollable}
::::: columns
...
your platform, how to make a file and run it, the DataFrame basics, and every name from sessions 1 to 13, each with a line showing it in use.

> **[Python Cheatsheet · Session 13](https://warint.github.io/quantitative-methods/python-cheatsheet-13.pdf)** (PDF) ·
> in the repository at `13-…/PYTHON-CHEATSHEET.pdf`
...
## After the course {.scrollable}

::: {.step}
**One more thing, and it is optional.** Nothing here is examined. It is the method
you will need the first time a client hands you forty indicators and asks for one index.
:::

::: {.step}
The **QMIB Lab** for this material — a knowledge check you can take at your own
pace: **[warin.ca/qmib-labs](https://warin.ca/qmib-labs/qmib-lab-07.html)**
:::

::: {.muted}
The lab still carries its original number, 07, from when this was session 7.
:::
