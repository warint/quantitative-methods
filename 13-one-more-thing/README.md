# Session 13 — One More Thing: Principal Component and Factor Analyses

> **How many independent things are actually being measured?**

> **[Open the lecture slides](https://warint.github.io/quantitative-methods/session-13-lecture.html)** — or read the source at
> [`01-lecture/MATH60033A-S13-Lecture.qmd`](01-lecture/MATH60033A-S13-Lecture.qmd).

**Unscheduled** · after Session 12, for self-study · not examined
...
| **After class** | At home, optional | The **QMIB Lab** — a knowledge check on this session | [warin.ca/qmib-labs](https://warin.ca/qmib-labs/qmib-lab-07.html) |
...
In `groups/A2026/group-XX/session-13/`: a dimension-reduction of your project's indicators: the scree plot, the number retained with its justification, the loadings interpreted, and a note on what you are *not* entitled to call the components.

---

[<- [Session 12: Final Group Presentations](../12-group-presentations/README.md)](../12-group-presentations/README.md)
