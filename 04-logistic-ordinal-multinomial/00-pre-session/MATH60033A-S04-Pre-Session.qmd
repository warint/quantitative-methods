...
```bash
mkdir -p 04-logistic-ordinal-multinomial/data/replication && cd 04-logistic-ordinal-multinomial/data/replication
curl -L -o replication.zip \
  "https://dataverse.harvard.edu/api/access/dataset/:persistentId/?persistentId=doi:10.7910/DVN/ONOFS7"
...
```powershell
mkdir 04-logistic-ordinal-multinomial/data/replication; cd 04-logistic-ordinal-multinomial/data/replication
