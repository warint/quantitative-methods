...
::: {.get}
**Deliverable.** A logistic model of a binary outcome in your own project data, with the odds ratios interpreted in words, and a note on what the model does not license you to say.
:::
