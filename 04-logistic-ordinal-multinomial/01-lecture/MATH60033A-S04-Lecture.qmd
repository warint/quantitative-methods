...
- `.fit()` — estimate the model you specified · *new in session 3*
- `smf.ols` — least squares, from a formula · *new in session 3*

### Read the fit

- `.mse_resid` — its square root is the RSE, in units · *new in session 3*
- `.params` — the coefficients, in units of $y$ · *new in session 3*
- `.resid / .fittedvalues` — what is left, and what was predicted · *new in session 3*
- `.rsquared` — share of variance explained · *new in session 3*
...
- `plt.scatter` — the data, before anything else · *new in session 3*
- `plt.stem` — one spike per observation · *new in session 3*
- `plt.xlabel / plt.ylabel` — say the units, every time · *new in session 3*
