...
**Does SES matter at all?** SES has four coefficients — two indicators in two equations — so no single z-test answers that. Use the likelihood-ratio test from earlier in the session:
