...
> source: [`MATH60033A-S11-Practice.qmd`](MATH60033A-S11-Practice.qmd)
...
mkdir -p groups/A2026/group-XX/session-11
```
...
[<- The lecture](../01-lecture/README.md) · [Session 11 overview](../README.md)
