...
data = qmib.load("core")     # the session's own data
```

::: {.muted}
Paper: Atkin, Khandelwal & Osman (2017), *Exporting and Firm Performance: Evidence from a Randomized Experiment*, Quarterly Journal of Economics 132(2) · [10.7910/DVN/QOGMVI](https://doi.org/10.7910/DVN/QOGMVI)
:::
