...
The 52 names below came out of sessions 2–9. Today's slides assume them, and add to them. The ones marked arrived last week.
...
- `np.cov` — the matrix the model is trying to reproduce · *new last week*
...
- `semopy.Model` — from a model description string · *new last week*
...
- `.inspect()` — loadings and paths, estimated · *new last week*
...
- `semopy.calc_stats` — CFI, TLI, RMSEA — report all three · *new last week*
