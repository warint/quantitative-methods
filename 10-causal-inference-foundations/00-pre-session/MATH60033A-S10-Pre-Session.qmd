...
::: {.step}
[10.7910/DVN/QOGMVI](https://doi.org/10.7910/DVN/QOGMVI)
:::
...
```bash
mkdir -p 10-causal-inference-foundations/data/replication && cd 10-causal-inference-foundations/data/replication
curl -L -o replication.zip \
  "https://dataverse.harvard.edu/api/access/dataset/:persistentId/?persistentId=doi:10.7910/DVN/QOGMVI"
...
```powershell
mkdir 10-causal-inference-foundations/data/replication; cd 10-causal-inference-foundations/data/replication
