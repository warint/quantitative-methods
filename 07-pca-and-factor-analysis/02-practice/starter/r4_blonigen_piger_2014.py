...
Step-by-step guide: 07-pca-and-factor-analysis/02-practice/replications/R4-blonigen-piger-2014.md

Run it in VS Codium with the Run button (the triangle, top right), or from the
repository root in the terminal:

    python 07-pca-and-factor-analysis/02-practice/starter/r4_blonigen_piger_2014.py
