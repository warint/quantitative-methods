...
```bash
mkdir -p 07-pca-and-factor-analysis/data/replication && cd 07-pca-and-factor-analysis/data/replication
curl -L -o replication.zip \
  "https://dataverse.harvard.edu/api/access/dataset/:persistentId/?persistentId=doi:10.7910/DVN/NKWMQM"
...
```powershell
mkdir 07-pca-and-factor-analysis/data/replication; cd 07-pca-and-factor-analysis/data/replication
