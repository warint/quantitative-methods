...
2. Quote of the day
3. Introduction
4. Measuring the center
5. Measuring the spread
6. Measuring the shape
7. Measuring the shape (cont.)
8. Conclusion
...
your platform, how to make a file and run it, the DataFrame basics, and every name from sessions 1 to 2, each with a line showing it in use.

> **[Python Cheatsheet · Session 02](https://warint.github.io/quantitative-methods/python-cheatsheet-02.pdf)** (PDF) ·
> in the repository at `02-…/PYTHON-CHEATSHEET.pdf`
...
## Class Organization {#imported-s02-002 .scrollable}
...
## Introduction {#imported-s02-005 .scrollable}
...
## Introduction (cont.) {#imported-s02-006 .scrollable}
...
## Introduction - Differences between statistics and statistical learning? (cont.) {#imported-s02-008 .scrollable}
...
## Introduction - Differences between statistics and statistical learning? (cont.) {#imported-s02-009 .scrollable}
...
## Introduction - Differences between statistics and statistical learning? (cont.) {#imported-s02-010 .scrollable}
...
## Introduction - Differences between statistics and statistical learning? (cont.) {#imported-s02-011 .scrollable}
...
## The basics: the sample mean (cont.) {#imported-s02-015 .scrollable}
...
![](economist-assets/mean-median.png){.quarto-figure .quarto-figure-center style="width:80.0%"}
...
-   All three can share the **same mean and the same variance**: kurtosis is about shape, not spread

### Skewness/Kurtosis 2

![](economist-assets/shape.png){.quarto-figure .quarto-figure-center style="width:96.0%"}
:::

## Measuring the shape (cont.) {#imported-s02-026 .center .scrollable}
...
-   Every number today described **one** variable at a time
-   Session 03 puts two variables in the same sentence: it fits the smallest possible model, and then asks whether that model can be trusted
...
you have just sat through: **[warin.ca/qmib-labs](https://warin.ca/qmib-labs/qmib-lab-02.html)**
:::
