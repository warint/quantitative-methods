...
- **Session 03** fits a mean function by least squares — the straight line through the cloud, which
  used to close this session and now opens that one. Its standard errors lean on the spread you
  measured here, and its diagnostics are residual shape by another name.
