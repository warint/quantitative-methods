...
mkdir -p groups/A2026/group-XX/session-02      # macOS and Linux
```

```powershell
git checkout -b group-XX
mkdir groups/A2026/group-XX/session-02         # Windows — no -p
```
...
```bash
mkdir -p 02-exploratory-data-analysis/data/replication      # macOS and Linux
...
```powershell
mkdir 02-exploratory-data-analysis/data/replication         # Windows
cd 02-exploratory-data-analysis/data/replication
...
**[warin.ca/qmib-labs](https://warin.ca/qmib-labs/qmib-lab-02.html)**
:::
