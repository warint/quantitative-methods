...
scores = {
    ...
    "lasso (CV)":  test_rmse(make_pipeline(StandardScaler(), LassoCV(cv=5, random_state=0, max_iter=50_000))),
    "elastic net": test_rmse(make_pipeline(StandardScaler(), ElasticNetCV(l1_ratio=L1S, cv=5, random_state=0, max_iter=50_000))),
}
```
