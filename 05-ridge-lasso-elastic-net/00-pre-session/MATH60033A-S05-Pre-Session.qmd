...
```bash
mkdir -p 05-ridge-lasso-elastic-net/data/replication && cd 05-ridge-lasso-elastic-net/data/replication
curl -L -o replication.zip \
  "https://dataverse.harvard.edu/api/access/dataset/:persistentId/?persistentId=doi:10.7910/DVN/QJEUKR"
...
```powershell
mkdir 05-ridge-lasso-elastic-net/data/replication; cd 05-ridge-lasso-elastic-net/data/replication
