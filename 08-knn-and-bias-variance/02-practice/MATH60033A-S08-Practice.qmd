...
data = qmib.load("jst")     # the session's own data
```

::: {.muted}
Paper: Bluwstein, Buckmann, Joseph, Kapadia & Şimşek (2023), *Credit growth, the yield curve and financial crisis prediction: evidence from a machine learning approach*, Journal of International Economics 145 · data: `qmib.load("jst")`
:::
...
**[warin.ca/qmib-labs](https://warin.ca/qmib-labs/qmib-lab-08.html)**
:::
