...
8. K-Nearest Neighbors (cont.)
9. KNN by hand (you are the algorithm)
10. KNN by hand (you are the algorithm) (cont.)
11. KNN by hand
12. KNN in R code (you are not longer the algorithm)
13. Machine Learning: using KNN as an example
14. Smarket: 1,250 daily S&P 500 returns. ISLR ships it as a CSV. (cont.)
15. Train on everything before 2005, test on 2005 — a time split, not a random one (cont.)
16. KNN has no coefficients — importance is measured by scrambling a column (cont.)
17. The confusion matrix, and the accuracy that goes with it (cont.)
18. Big lessons from ML
19. Big lessons
20. Big lessons (cont.)
