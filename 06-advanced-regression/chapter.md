...
$$
y_{it} \thickspace=\thickspace \alpha_i + \beta x_{it} + \varepsilon_{it} .
$$
...
$$
y_{it} \thickspace=\thickspace \alpha_i + \gamma_t + \beta x_{it} + \varepsilon_{it} .
$$
...
$$
y_{it} \thickspace=\thickspace \mu + \beta x_{it} + u_i + \varepsilon_{it},
...
$$
y_{it} \thickspace=\thickspace \alpha_i + \beta x_{it} + \delta\thinspace(x_{it} \times g_i) + \varepsilon_{it},
$$
