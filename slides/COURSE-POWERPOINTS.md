...
| 07 | [Pre-session (Quarto)](../07-replication-workshop/00-pre-session/MATH60033A-S07-Pre-Session.qmd) | [Lecture (Quarto)](../07-replication-workshop/01-lecture/MATH60033A-S07-Lecture.qmd) | [Practice (Quarto)](../07-replication-workshop/02-practice/MATH60033A-S07-Practice.qmd) | [`check_setup.py`](../07-replication-workshop/02-practice/starter/check_setup.py) |
...
| 13 | [Pre-session (Quarto)](../13-one-more-thing/00-pre-session/MATH60033A-S13-Pre-Session.qmd) | [Lecture (Quarto)](../13-one-more-thing/01-lecture/MATH60033A-S13-Lecture.qmd) | [Practice (Quarto)](../13-one-more-thing/02-practice/MATH60033A-S13-Practice.qmd) | [`session13_ensembles_demo.py`](../13-one-more-thing/demo/session13_ensembles_demo.py) |
