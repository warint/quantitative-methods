...
[Session 11 practice](../../11-causal-inference-did/02-practice/README.md); here you finish them.

### 1. Model governance file  *(7 of the team work's 20)*

- [ ] All seven sections of [`governance-file-template.md`](../../11-causal-inference-did/02-practice/governance-file-template.md) completed
